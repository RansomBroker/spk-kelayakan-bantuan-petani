...
CREATE TABLE `hasil` (
  `id` int(255) NOT NULL,
  `id_petani` int(255) NOT NULL,
  `nilai_akhir` decimal(6,0) NOT NULL,
...
CREATE TABLE `settings` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `luas_lahan` decimal(65,2) NOT NULL,
  `penghasilan` decimal(65,2) NOT NULL,
  `hasil_panen` decimal(65,2) NOT NULL,
  `lama_usaha_tani` decimal(65,2) NOT NULL,
  `jmlh_anggota_keluarga` decimal(65,2) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
